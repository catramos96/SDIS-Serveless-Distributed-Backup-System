...
public class Client {
	...
	public static void main(String[] args) throws IOException{
		...
		while(true){
			MulticastSocket mcast_socket = new MulticastSocket(port);
			mcast_socket.joinGroup(address);
			byte[] msg = new byte[1000];
			DatagramPacket mcast_packet = new DatagramPacket(msg,msg.length);
			mcast_socket.receive(mcast_packet);
			
			System.out.println(new String(mcast_packet.getData()));
		}
		/*
